...
//   const paymentData = await prisma.paymentSession.create({
//     data: {
//       ...paymentSession,
...
//     },
//   });
//   console.log("🚀 ~ createPaymentSession ~ data:", paymentData);
//   return paymentData;
// };
...
export const createPaymentSession = async (paymentSession) => {
  try {
    ...
    // console.log("cancelUrl:", cancelUrl); // Log cancelUrl to verify its presence

    // Create payment session in the database
    const paymentData = await prisma.paymentSession.create({
      data: {
        ...paymentSession,
        amount: parseFloat(amount),
    ...
    // console.log("Payment session created successfully:", paymentData);
